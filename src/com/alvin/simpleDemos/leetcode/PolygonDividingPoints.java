...
public class PolygonDividingPoints {
    public static void main(String[] args) {
        Vertex[] givenVertices = {new Vertex(1, 2), new Vertex(1, 10), new Vertex(5, 10), new Vertex(5, 2)};
            ...
            if (vertices[i].getX() == vertices[next].getX()){
                ...
                if (lengthLeft <= distance){
                    if (vertices[i].getY() < vertices[next].getY()){
                        ...
                        while(lengthLeft <= distance){
                            kVertices[index] = new Vertex(vertices[i].getX(), vertices[i].getY() + (base + lengthLeft));
                ...
                if (lengthLeft <= distance){
                    if (vertices[i].getX() < vertices[next].getX()){
                        double base = 0;
                        while(lengthLeft <= distance){
                            kVertices[index] = new Vertex(vertices[i].getX() + (base + lengthLeft), vertices[i].getY());
