...
public class ObjectHeaderTest {
     ...
     *
     * 2. 无锁不可偏向 (有哈希值) => 计算了 hashcode,对象头中放不下偏向线程 id 001
     * 7e0e6aa2
     * java.lang.Object object internals:
     *  OFFSET  SIZE   TYPE DESCRIPTION                               VALUE
     *       0     4        (object header)                           01 a2 6a 0e (00000001 10100010 01101010 00001110) (241869313)
     ...
     * java.lang.Object object internals:
     *  OFFSET  SIZE   TYPE DESCRIPTION                               VALUE
     *       0     4        (object header)                           05 70 14 cf (00000101 01110000 00010100 11001111) (-820744187)
     *       4     4        (object header)                           9e 02 00 00 (10011110 00000010 00000000 00000000) (670)
     *       8     4        (object header)                           00 02 00 20 (00000000 00000010 00000000 00100000) (536871424)
     *      12     4        (loss due to the next object alignment)
     * Instance size: 16 bytes
     * Space losses: 0 bytes internal + 4 bytes external = 4 bytes total
     *
     * 4. 有锁，是轻量锁 => 计算 hashcode 仅在 synchronized 代码块外，则该锁是轻量锁 000
     * 18bf3d14
     * java.lang.Object object internals:
     *  OFFSET  SIZE   TYPE DESCRIPTION                               VALUE
     *       0     4        (object header)                           d0 f5 ff 33 (11010000 11110101 11111111 00110011) (872412624)
     ...
     * Space losses: 0 bytes internal + 4 bytes external = 4 bytes total
     *
     * 5. 有锁，是重量锁 => 计算 hashcode 在 synchronized 代码块内，则该锁是重量锁 010
     * 4fb64261
     * java.lang.Object object internals:
     *  OFFSET  SIZE   TYPE DESCRIPTION                               VALUE
     *       0     4        (object header)                           82 9d ee 62 (10000010 10011101 11101110 01100010) (1659805058)
     *       4     4        (object header)                           73 01 00 00 (01110011 00000001 00000000 00000000) (371)
     *       8     4        (object header)                           00 02 00 20 (00000000 00000010 00000000 00100000) (536871424)
     *      12     4        (loss due to the next object alignment)
     * Instance size: 16 bytes
     * Space losses: 0 bytes internal + 4 bytes external = 4 bytes total
