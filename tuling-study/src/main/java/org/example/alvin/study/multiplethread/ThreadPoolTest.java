...
public class ThreadPoolTest {
  ...
  /**
   * scheduleWithFixedDelay is more safe than scheduleAtFixedDelay, because it can make sure the
   * execution times and interval between each task execution ending and the next starting
   */
  ...
  private static void testShutdown() {
    ExecutorService pool1 =
        new ThreadPoolExecutor(2, 2, 0, TimeUnit.MILLISECONDS, new ArrayBlockingQueue<>(1));
